    ...
    <>
      ...
      <div className="mb-8 flex items-center justify-between">
        ...
        <button
          ...
          className="px-4 py-2 bg-orange-500 text-white font-semibold rounded-lg shadow-md hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-opacity-75 flex items-center"
        >
      ...
      <div className="mt-8 flex flex-col items-center space-y-4">
        ...
        <div className="text-center p-8 bg-[#FFF4E8] rounded-3xl shadow-sm max-w-4xl w-full mx-auto">
