          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-6">
            <div className="bg-gray-50/80 border border-gray-200 rounded-lg p-4">
              <div className="flex items-start justify-between">
                <div>
                  <h3 className="font-bold text-lg mb-2">Ideas.directory</h3>
                </div>
                <a 
                  href="https://ideas.directory/"
                  target="_blank"
            ...
            <div className="col-span-full bg-gray-50/80 border border-gray-200 rounded-lg p-4">
              ...
              <div className="space-y-6">
                <div>
                  <h4 className="font-bold text-xl mb-2">Links & Navigation</h4>
                  <p className="text-lg font-semibold text-yellow-600">Score: 67%</p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-lg font-bold mt-2">No internal links found</p>
                  <p className="text-lg font-bold mt-2">Suggestion</p>
                  <p className="text-base">Add more internal links to improve site structure and help search engines understand your content hierarchy.</p>
                </div>
                
                <div>
                  <h4 className="font-bold text-xl mb-2">Indexation & Robots.txt</h4>
                  <p className="text-lg font-semibold text-yellow-600">Score: 25%</p>
                </div>
                
                <div>
                  <h4 className="font-bold text-xl mb-2">Robots.txt</h4>
                  <p className="text-lg font-semibold text-red-600">Score: 0%</p>
                  <p className="text-base">A robots.txt file is used to tell search engine crawlers which pages they can or cannot access on your site.</p>
                  <p className="text-lg font-bold mt-2">Error</p>
                  <p className="text-base">Failed to check robots.txt: Invalid robots.txt content type</p>
                  <p className="text-lg font-bold mt-2">Suggestion</p>
                  <p className="text-base">There was an error checking the robots.txt file. Please ensure your site has a valid robots.txt file to guide search engine crawlers and improve your site's indexing.</p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-lg font-bold mt-2">No canonical URL found</p>
                  <p className="text-lg font-bold mt-2">Suggestion</p>
                  <p className="text-base">Add a canonical URL to specify the preferred version of this page.</p>
                </div>
                ...
                <div>
                  <h4 className="font-bold text-xl mb-2">Meta & SEO Tags</h4>
                  <p className="text-lg font-semibold text-red-600">Score: 0%</p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-lg font-semibold text-red-600">Score: 0%</p>
                  <p className="text-base">The title tag is one of the most important elements for SEO and appears in search results.</p>
                  <p className="text-lg font-bold mt-2">No title found</p>
                  <p className="text-lg font-bold mt-2">Suggestion</p>
                  <p className="text-base">Add a title tag to improve your page visibility in search results.</p>
                </div>
                
                <div>
                  <h4 className="font-bold text-xl mb-2">Meta Description</h4>
                  <p className="text-lg font-semibold text-red-600">Score: 0%</p>
                  <p className="text-base">The meta description provides a brief summary of the page content for search results.</p>
                  <p className="text-lg font-bold mt-2">No meta description found</p>
                  <p className="text-lg font-bold mt-2">Suggestion</p>
                  <p className="text-base">Add a meta description to improve your search result appearance.</p>
                </div>
                
                <div>
                  <h4 className="font-bold text-xl mb-2">Open Graph</h4>
                  <p className="text-lg font-semibold text-red-600">Score: 0%</p>
                  <p className="text-base">The og:title, og:description and og:image tags are used to define the title, description and image of your content when shared on social media platforms.</p>
                  <p className="text-lg font-bold mt-2">No Open Graph title found</p>
                  <p className="text-lg font-bold mt-2">No Open Graph description found</p>
                  <p className="text-lg font-bold mt-2">No Open Graph image found</p>
                  <p className="text-lg font-bold mt-2">Suggestion</p>
                  <p className="text-base">Add an og:title tag to optimize how your content appears when shared on social media</p>
                </div>
                
                <div>
                  <h4 className="font-bold text-xl mb-2">Content Structure & Accessibility</h4>
                  <p className="text-lg font-semibold text-yellow-600">Score: 20%</p>
                </div>
                
                <div>
                  <h4 className="font-bold text-xl mb-2">Word Count</h4>
                  <p className="text-lg font-semibold text-red-600">Score: 0%</p>
                  <p className="text-base">The word count is used to determine the number of words on the page, which can impact SEO and user engagement.</p>
                  <p className="text-lg font-bold mt-2">Word count is below optimal level</p>
                  <p className="text-lg font-bold mt-2">Word count found</p>
                  <p className="text-lg font-bold mt-2">Suggestion</p>
                  <p className="text-base">Consider adding more content to reach a minimum of 300 words for better SEO.</p>
                </div>
                
                <div>
                  <h4 className="font-bold text-xl mb-2">Images Alt Tags</h4>
                  <p className="text-lg font-semibold text-red-600">Score: 0%</p>
                  <p className="text-base">Image alt tags are important for accessibility and SEO, providing context for images when they cannot be displayed.</p>
                  <p className="text-lg font-bold mt-2">Suggestion</p>
                  <p className="text-base">Add descriptive alt tags to images that are missing them to improve accessibility and SEO.</p>
                </div>
                
                <div>
                  <h4 className="font-bold text-xl mb-2">Headings Structure</h4>
                  <p className="text-lg font-semibold text-yellow-600">Score: 80%</p>
                  ...
                  <p className="text-base">No H1 heading found</p>
                  <p className="text-lg font-bold mt-2">Suggestion</p>
                  <p className="text-base">Improve your heading structure: No H1 heading found</p>
                </div>
                
                <div>
                  <h4 className="font-bold text-xl mb-2">Favicon</h4>
                  <p className="text-lg font-semibold text-red-600">Score: 0%</p>
                  <p className="text-base">A favicon helps with brand recognition and improves the overall user experience of your site.</p>
                  <p className="text-lg font-bold mt-2">No favicon found</p>
                  <p className="text-base">No favicon link tag detected</p>
                  <p className="text-lg font-bold mt-2">Suggestion</p>
                  <p className="text-base">Add a favicon to improve brand recognition and user experience.</p>
                </div>
                ...
                <div>
                  <h4 className="font-bold text-xl mb-2">Keywords</h4>
                  <p className="text-lg font-semibold text-red-600">Score: 0%</p>
                </div>
                ...
                <div>
                  <h4 className="font-bold text-xl mb-2">Keywords</h4>
                  <p className="text-lg font-semibold text-red-600">Score: 0%</p>
                  <p className="text-base">Keywords are crucial for SEO, ensuring a smooth user experience and proper page indexing.</p>
                  <p className="text-lg font-bold mt-2">No keywords found</p>
                  <p className="text-lg font-bold mt-2">Suggestion</p>
                  <p className="text-base">Add keywords to ensure a smooth user experience and proper page indexing.</p>
                </div>
              </div>
            </div>

            <div className="col-span-full mt-6 bg-orange-100 border-2 border-orange-500 rounded-lg p-6">
              <h3 className="text-2xl font-bold mb-4 text-center">IMPORTANT: SEO Optimization Required</h3>
              <p className="text-xl font-semibold mb-4 text-center">
                Your website's SEO needs immediate attention to improve its search engine performance and visibility.
              </p>
              <p className="text-lg mb-4">
                Based on the analysis above, we strongly recommend taking action on the following key areas:
              </p>
              <ul className="list-disc list-inside text-lg space-y-2 mb-4">
                <li>Implement proper meta tags (title, description, Open Graph)</li>
                <li>Add internal links to improve site structure</li>
                <li>Create and optimize your robots.txt file</li>
                <li>Implement structured data for rich search results</li>
                <li>Optimize content length and keyword usage</li>
                <li>Improve heading structure and image alt tags</li>
              </ul>
              <p className="text-lg font-semibold text-center">
                Addressing these issues will significantly boost your website's SEO performance and online visibility.
              </p>
            </div>

            <div className="col-span-full mt-6 bg-orange-100 border-2 border-orange-500 rounded-lg p-6">
              <h3 className="text-2xl font-bold mb-4">Boost Your SEO with Our Blog Service</h3>
              <p className="text-lg mb-4">
